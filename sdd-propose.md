...
Create the change folder structure if it does not already exist:
...
### New Capabilities
<!-- Each entry becomes a new `openspec/specs/<name>/spec.md`. Use kebab-case names. -->
- `<capability-name>`: <brief description>

### Modified Capabilities
<!-- Each entry needs a delta spec in the change folder. Use existing names from openspec/specs/. -->
...
- If nothing changes at the spec level (pure refactor), explicitly write "None" under both sub-sections
