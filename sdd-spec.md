...
Read `openspec/changes/{change-name}/proposal.md`. The **Capabilities section** is your primary contract:
...
If the proposal has no Capabilities section (older format), infer from "Affected Areas".
...
- **Size budget**: Spec artifact MUST be under 650 words. Each scenario: 3-5 lines max.
