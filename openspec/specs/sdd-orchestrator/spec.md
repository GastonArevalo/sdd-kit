# sdd-orchestrator Specification

## Purpose

Defines the orchestrator's responsibilities for state tracking across the SDD phase lifecycle.
...
- WHEN the orchestrator handles `/sdd-continue`
- THEN it MUST fall back to filesystem inspection and proceed from the last artifact found
